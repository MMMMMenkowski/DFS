...
# fcn
def fcn32s(num_classes=21, output_stride=None, pretrained_backbone=None):
    return _load_model("fcn32s", "fcn32s", num_classes, output_stride, pretrained_backbone)

def fcn16s(num_classes=21, output_stride=None, pretrained_backbone=None):
    return _load_model("fcn16s", "fcn16s", num_classes, output_stride, pretrained_backbone)

def fcn8s(num_classes=21, output_stride=None, pretrained_backbone=None):
    return _load_model("fcn8s", "fcn8s", num_classes, output_stride, pretrained_backbone)


# unet
def unet(num_classes=21, output_stride=None, pretrained_backbone=None):
